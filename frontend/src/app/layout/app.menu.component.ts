						...
						items: [
								  {
									...
									routerLink: ['/app/admin/adresse/rue/list']
								  },
								  {
									label: 'Liste quartier',
									icon: 'pi pi-fw pi-plus-circle',
									routerLink: ['/app/admin/adresse/quartier/list']
								  },
								  {
									label: 'Liste locale',
									icon: 'pi pi-fw pi-plus-circle',
									routerLink: ['/app/admin/adresse/locale/list']
								  },
						]
					  },
					  {
						label: 'CategorieLocale',
						icon: 'pi pi-wallet',
						items: [
								  {
									label: 'Liste categorie locale',
									icon: 'pi pi-fw pi-plus-circle',
									routerLink: ['/app/admin/taxe/categorie-locale/list']
								  },
						]
					  },
